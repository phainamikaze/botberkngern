...
const ItemUpdatedMessage = (title,details) => {
  return {text: 'มีการอัพเดทสถานะของ '+details+' ในรายการ '+title};
};
const ItemInsertMessage = (title,details) => {
  return {text: 'มีการเพิ่ม '+details+' ลงในรายการ '+title};
};
const listDelMessage = (title) => {
  return {text: 'ลบรายการ '+title+' เรียบร้อย'};
};
